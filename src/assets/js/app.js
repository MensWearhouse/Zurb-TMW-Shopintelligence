...
//open and close triggers for mobile shoptelligence carousel
$('[data-carousel-open]').click(function() {
  $('.shoptelligence-carousel-mobile').addClass('is-active');
});

$('[data-close]').click(function(e) {
  e.preventDefault();
  $('.shoptelligence-carousel-mobile').toggleClass('is-active');
});


//animate scroll to shoptelligence for desktop
